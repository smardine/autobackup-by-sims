...
public class Fen_Download_FireBird extends JFrame {
	 ...
	 */
	public Fen_Download_FireBird() {
		super();
		initialize();

		final long HeureDebut = System.currentTimeMillis();
		long HeureActuelle;
		final String urlsetup = "http://autobackup-by-sims.googlecode.com/files/Firebird-2.0.3.12981-1-Win32.exe";
	...
	private void initialize() {
		...
		this.setTitle("Telechargement de Firebird");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel
					.setText(" Veuillez patienter pendantle téléchargement de Firebird...");
